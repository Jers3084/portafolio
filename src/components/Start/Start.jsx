...
export const Start = (props) => {
  return (
    ...
    { props.lang==="es-419" ? (
      ...
      <div className={styles.fotostart}></div>
      <h2 className={styles.parrafo_uno}>Hello, my name is Jesus Eugenio Ricardez and I am a Webfullstack Designer and Developer</h2>
      <h2 className={styles.parrafo_dos}>This page is designed so that you know my work, I invite you to go through it and if you are interested in what I do, do not hesitate to contact me.</h2>
      </div>
    )}
    </>
  )
